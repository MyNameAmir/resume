...
class App extends React.Component {
    ...
    handleCommentSubmit(event) {
        ...
        if(this.state.comment != '' && this.state.comment != undefined){
            ...
            this.setState({
                commentSuccessMessage: `Please submit something in the comments.`
            })
        }
            ...
            <div className="wrapper" style={scrollStyle}>
                ...
                <div className="everythingElse">
                    <div className="intro" id="home" ref={this.homeRef}>
                        <div id="restOfIntro">
                            <img className="circularImage" width="150px" height="150px" src="amir.png" alt="main image" />
                            <h1 className="h1">👋🏼 Hi , My name is<br></br><strong></strong>Amir Moin</h1>
                            <span className='pulse-button'><a id="pulseA" href="#about">Start Here</a></span>
                        </div>
                    </div>
                    <div className="restOfEverything">
                        ...
                        <form onSubmit={this.handleCommentSubmit}>
                            ...
                            <br></br>
                            <textarea className="comment" placeholder="your comment goes here..." onChange={this.handleCommentChange} value={this.state.comment} name="comment" cols="40"></textarea>
                            <br></br>
                ...
                <div class="topnav">
                        <a href="#home" class="active">Amirali Moin</a>
